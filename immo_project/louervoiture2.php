...
<html>
	...
	<section class=center3>
		<div class=center><br/>
		<strong><h1>Location Toyota Land Cruiser </h1></strong>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<aside>
		<ul class="diaporama">
			<li><img src="imgSlide3/voiture21.jpg" alt="Image 1" width="512" height="288" /></li>
			<li><img src="imgSlide3/voiture22.jpg" alt="Image 2" width="512" height="288"/></li>
			<li><img src="imgSlide3/voiture23.jpg" alt="Image 3" width="512" height="288"/></li>
		</aside>
		<?php
		$panErr = "";
		if(isset($_SESSION['id']) AND isset($_SESSION['email']))
		{
			...
			$titre = 'Location voiture2 située à Pointe-Noire';
		...
		<p>Marque : Toyota Land Cruiser <br />
			Puissance : 407 ch <br />
			Carburant :  Essence <br />
			Boîte de vitesse : Automatique <br />
			Cylindré : 4,4l <br />
			Couleur : Rouge <br />
			Nbre de Places : 4/5 <br />
			Intérieur :Cuir belge <br />
			Montant :50000000 <br />
</p>
