...
<html>
	...
	<section class=center3>
		<div class=center><br/>
		<strong><h1>Immeuble situé à Brazzaville</h1></strong>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<aside>
		<ul class="diaporama">
			<li><img src="imgSlide3/immeuble11.jpg" alt="Image 1" width="512" height="288" /></li>
			<li><img src="imgSlide3/immeuble12.jpg" alt="Image 2" width="512" height="288"/></li>
			<li><img src="imgSlide3/immeuble13.jpg" alt="Image 3" width="512" height="288"/></li>
			<li><img src="imgSlide3/immeuble14.jpg" alt="Image 4" width="512" height="288"/></li>
			<li><img src="imgSlide3/immeuble15.jpg" alt="Image 5" width="512" height="288"/></li>
		</aside>
		<?php
		$panErr = "";
		if(isset($_SESSION['id']) AND isset($_SESSION['email']))
		{
			...
			$titre = 'Immeuble situé à Brazzaville';
		...
		<b class="darkorange">25.000.000.000 FCFA</b><br />
